...
// Booking a room is a regular-user action — admins manage the system,
// they don't occupy rooms as members.
bookingsRouter.post("/", authenticate, authorize("USER"), postBooking);
